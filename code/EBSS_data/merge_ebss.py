...
def merge_jsonl(input_file, output_file, group_size=2):
    """
...
# 配置参数
input_filename = 'ebss_qwen15_selfbuild_ori.jsonl'
output_filename = 'ebss_qwen15_selfbuild_merged_len512.jsonl'
