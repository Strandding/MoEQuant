...
SAVE_PATH="/dataset/common/quant_model/moequant_${short_name}_w${W_BITS}_selfebss_nsample_${N_SAMPLES}_groupsize${gsize}_rotate_old.pth"
RES_DIR="./res_moe_${short_name}_base_w${W_BITS}_selfebss_nsample_${N_SAMPLES}"
LOG_FILE="./output_log/${short_name}_w${W_BITS}_nsample_${N_SAMPLES}_groupsize${gsize}_${TIMESTAMP}_rotate_old.txt"
