...
supported_models = [
            ...
            'facebook/opt-125m',
            '/dataset/common/pretrain_model/Qwen3-30B-A3B-Base',
            '/dataset/common/pretrain_model/Qwen1.5-MoE-A2.7B',
            '/dataset/common/pretrain_model/DeepSeek-V2-Lite',
            '/dataset/common/pretrain_model/Qwen3-Next-80B-A3B-Instruct',
            '/dataset/common/pretrain_model/Mixtral-8x7B-v0.1'
            ]
...
def parser_gen():
    ...
    parser.add_argument('--gate_up_group_size', type=int, default=60,
                        help='Experts per group when quantizing gate+up together.')
    parser.add_argument('--down_group_size', type=int, default=60,
                        help='Experts per group when quantizing down_proj.')
    ...
    args.save_path = '/export/home2/zihan/MoEQuant/code/log'
